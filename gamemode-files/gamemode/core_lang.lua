...
--[[
	Description: Allows extensions to dynamically add text
--]]
...
_L.StyleBonusNone = "There is no bonus set1;"
_L.StyleBonusSub = "Your bonus type has been changed to 1;"
...
_L.VoteCancelled = "The vote was cancelled by an admin, thus the map will not change."
...
_L.BotSlow = "Your time was not good enough to replace the top WR bot (+1;). If you still want to save your run, typing \"!bot force\" might help"
_L.BotSaving = "The server will now save 1; run2;, 3;"
_L.BotSaved = "1; 2; been saved in 3;"
_L.BotMultiWait = "The bot must have at least finished playback once or have passed the 1 minute mark before it can be changed."
_L.BotMultiInvalid = "The entered style was invalid or there are no bots for this style."
_L.BotMultiError = "An error occurred when trying to retrieve data to display. Please wait and try again."
_L.BotMultiSame = "The bot is already playing this style."
_L.BotMultiExclude = "The bot can not display the Normal style run. Check the main bot for that!"
_L.BotDetails = "The bot run was done by 1; [2;] on the 3; style in a time of 4; at this date: 5;"
_L.BotDetailsNone = "There are no recorded runs on the 1; style."
_L.BotQueue = "You are not instantly recorded because the server is rather full. If you wish to be recorded, type /bot add"
_L.BotAllSaved = "All your bots have already been saved or you have no bots."
_L.BotSaveForced = "Your !bot force'd run can't be saved with this command, please wait for the map to change."
_L.BotImportOverride = "You can't override an existing bot. Please remove that bot first before proceeding."
_L.BotImportFiles = "Either one of the files isn't accessible or writable. Please check the files."
_L.BotImportSucceeded = "The bot has been imported to the given bot slot! It has automatically been saved."
_L.BotNoValidBots = "No valid bot to target"
_L.BotInvalidStyle = "Invalid target style"
_L.BotDisplaySameRun = "The bot is already displaying this run!"
_L.BotChangeMultiDone = "The bot is now displaying 1;'s 2; run (Time: 3;)"
_L.BotChangeMultiPlayback = "The current multi bot hasn't finished playback yet. Please wait 1 minute or until it has looped at least once."
_L.BotAdditionalNotEligible = "You are currently not eligible to force-save your bot. 1;"
_L.BotAdditionalInvalid = "You can only use this command straight after finishing the map"
_L.BotAdditionalNoTimes = "There are no bots on your style yet. This means this command will not be of any use for you"
_L.BotAdditionalTimeLimited = "Your time may not be faster than the current bot and not slower than 50% on top of the time of the current bot (1;)"
...
_L.CommandBotNoStyle = "There are no older bots for this style"
_L.CommandBotValidStyle = "Please select a valid style to load older bots from"
_L.CommandBotMultiNone = "There are no multi bot runs available"
_L.CommandBotRecordList = "Runs on these styles are recorded and playable: 1; (Use !bot 2; Style to start playback.)"
_L.CommandBotNoPlayback = "There are no other bots available for playback."
_L.CommandBotNoTarget = "You have to either spectate a bot or use !bot 1; [Style ID] to use this command."
_L.CommandBotWhoList = "These players are NOT being recorded by the bot (#1;): 2;"
_L.CommandBotWhoAll = "All players are being recorded by the replay bots."
_L.CommandBotRecordAlready = "You are already being recorded by the bot."
_L.CommandBotRecordSpawn = "You have to be in the spawn to re-add yourself to the recorded players"
_L.CommandBotRecordSuccess = "You are now being recorded by the bot again!"
_L.CommandBotRecordDisplay = "You are 1;being recorded by the bot"
_L.CommandBotForce = "1; is now being force-recorded; if the player finishes with a decent time it will be saved"
_L.CommandBotForceSelf = "You are being force-recorded; if you finish with a decent time it will be saved"
_L.CommandBotForceAlready = "Are are already being force-recorded"
_L.CommandBotForceSaved = "Your run has been put in the bot cache. It will be saved when the map changes. You will need to use !bot force again if you want it to stay active."
_L.CommandBotForceFeedback = "1; just finished the map and the bot was added to the history cache. It will be automatically saved on map change.\nTo record this player again, you have to use !bot force again."
_L.CommandBotDemoNone = "You have to spectate the bot that you want to record!"
_L.CommandBotDemoStarted = "Automatic recording activated. You have to keep spectating this bot now."
_L.CommandBotDemoDisable = "Automatic recording has been manually disabled!"
_L.CommandBotDemoEnded = "Automatic recording ended"
...
_L.MiscAFK = "Hey, wake up! You've been AFK for 1; minutes!"
_L.MiscAFKKicked = "You've been AFK for 1; minutes and because the player count is too high you have been kicked."
...
_L.Content.HelpText = {
	"Welcome to Jerry's Shithops " .. Core.Config.DisplayName,
	"",
	...
	"",
	"Bonus [Normal style, Auto Hop: ON, Air Accel: 1k]",
...
-- Active servers
_L.Content.ActiveServers = {
	{ "74.91.127.130:27015", "Bunny Hop (Easy)", { "easy", "main" } }
}
...
_L.Content.Commands = {
	...
	["botsave"] = "Saves your own bot (Same as !bot save)",
	...
	["radio"] = "Opens a radio with which you can play neat tunes",
...
_L.Content.StyleLookup = {
	...
	["shsw"] = Core.Config.Style.SHSW, ["sidehsw"] = Core.Config.Style.SHSW,
	...
	["b"] = Core.Config.Style.Bonus, ["bonus"] = Core.Config.Style.Bonus
}

-- Remote URLs
_L.Content.TutorialLink = "http://www.youtube.com/watch?v=vmREZAGx_B8"
_L.Content.WebsiteLink = "http://www.czarchasm.club/"
_L.Content.ChannelLink = "https://mega.nz/#!aIYHRYgS!z7ASATWZaxfkiMXzTjgiyEbxvE7ikR9CiVYvOwZqqTM"
_L.Content.ForumLink = "http://www.discord.gg/87YNx4Q"
_L.Content.ThreadLink = "http://paypal.me/czarchasm00"
_L.Content.ChangeLink = "http://www.discord.gg/87YNx4Q"

-- Server specific changes
if Core.Config.IsSurf then
	_L.Content.TutorialLink = "https://www.youtube.com/watch?v=lYc52kwTNb8"
	_L.Content.SurfWeapons = { ["weapon_glock"] = true, ["weapon_usp"] = true, ["weapon_knife"] = true, ["weapon_scout"] = true }
end